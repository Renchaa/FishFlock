...
namespace Flock.Scripts.Build.Influence.Noise.Profiles {
    ...
    public sealed class GroupNoisePatternProfile : ScriptableObject {
        ...
        /**
         * <summary>
         * Converts this profile into a runtime <see cref="GroupNoisePatternSettings"/> snapshot.
         * </summary>
        ...
        /**
         * <summary>
         * Converts the common (type-agnostic) settings into a runtime <see cref="GroupNoiseCommonSettings"/> snapshot.
         * </summary>
