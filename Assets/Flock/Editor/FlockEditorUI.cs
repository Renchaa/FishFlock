...
namespace Flock.Editor {
    ...
    /// </summary>
    internal static class FlockEditorUI {
        // ---------------------------
        // Labeling
        // ---------------------------
        ...
        // Spacing
        // ---------------------------
        public const float SpaceTiny = 1f;      // e.g., inside cards after title
        public const float SpaceSmall = 2f;     // e.g., small separators / array bottom space
        public const float SpaceMedium = 4f;    // e.g., toolbar bottom spacing
        ...
        public const float ListNameColumnWidth = 130f; // "label" column used in multiple list rows
        ...
        // (Optional but still "magic numbers" in your dropdown builder)
